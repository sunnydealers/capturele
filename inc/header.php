...
?>     
        ...
        <nav id="nav-bar" class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
            <div class="container-fluid"><a href="#" class="navbar-brand me-5 fw-blod fs-3 h-font"><img src="images/branding/logo.png" width="150px"></a>
                ...
                <form>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="text-center my-1">
                            <button type="submit" class="btn btn-dark shadow-noneS">Register</button>
                        </div>
                    </div>
                </form>
            </div>
